...
export const Route = createFileRoute('/product-diagrams')({
  head: () => ({
    meta: [
      { title: 'Product Diagrams | My Peptide Co' },
      { name: 'description', content: 'Chemical structure diagrams for all SARMs and peptides carried by My Peptide Co.' },
    ],
  }),
  component: InternalDiagrams,
});
