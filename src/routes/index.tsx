...
export const Route = createFileRoute('/')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: "Australia's #1 source for pharmaceutical-grade SARMs and peptides. Shop RAD-140, MK-677, BPC-157, TB-500 & more. 99%+ purity, third-party tested, same-day dispatch." },
      { rel: 'canonical', href: 'https://mypeptideco.com.au' },
    ],
  }),
  component: Index,
});
