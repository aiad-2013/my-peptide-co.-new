...
export const Route = createFileRoute('/lab-reports')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Third-party Certificates of Analysis for all SARMs and peptides sold by My Peptide Co. Verify purity and quality of every batch we carry.' },
    ],
  }),
